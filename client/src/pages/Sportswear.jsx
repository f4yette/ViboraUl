...
export default function Sportswear() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        if (!cancelled) setErrorMsg("Error loading sportswear.");
      } finally {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return allProducts.filter((p) => {
      ...
      const gender = (p?.level || "").toString().toLowerCase();
  ...
  }, [allProducts, term, brandFilter, priceFilter, genderFilter, materialFilter]);
      ...
      <div className="products-container" id="productsContainer">
        {loading ? (
          ...
          filteredProducts.map((product) => {
            ...
            const gender = (product?.level || "").toString();
              ...
              <div className="product-card" key={id ?? `${name}-${imageUrl}`}>
                ...
                <div className="product-info">
                  ...
                  <div className="product-meta">
                    ...
                    {gender ? <span className="product-level">{gender}</span> : null}
                    {material ? (
